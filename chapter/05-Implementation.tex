...
Now that we have a foundation for the flattening of programs in \ndp{}, we must explore what is required to implement it in the expressive, powerful, high-performance, and featureful array language, Accelerate. We will provide a high-level overview of the implementation. For more detailed information we refer to the publicly available implementation.\footnote{This is available at \url{https://github.com/AccelerateHS/accelerate/tree/feature/sequences}}
