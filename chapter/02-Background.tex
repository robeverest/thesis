...
The abstract syntax tree for the core Accelerate syntax is given in Lising~\ref{lst:acc-ast} for the @Acc@ stratum and Listing~\ref{lst:exp-ast} for @Exp@. These ASTs are defined as a Generalised Algebraic Datatype (GADT) and are parameterised by the recursive step @acc@.
