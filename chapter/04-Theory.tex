...
\finaltodo{This paragraph mentions things not explained or defined till later. Restructure!}
...
\finaltodo{This explanation of debruijn indices is not good. It needs to be refined. Also, syntax? It has been moved to background, so may need to be removed entirely?}
...
\finaltodo{One reviewer didn't understand what was going on here. This needs to be made clearer. Maybe a diagram?}
%
\begin{lstlisting}
0 + 3(1 + 4(2 + 5(0))) = 27
\end{lstlisting}
